...
namespace Lab2Ex1
{
    class Program
    {
        ...
        static List<string> GeneratePalindromes(string characters, int min, int max)
        {
            ...
            {
                GeneratePalindromeRec(characters, new char[length], 0, length - 1, palindromelist);
            }
        ...
        static void GeneratePalindromeRec(string characters, char[] current, int left, int right, List<string> palindromelist)
        {
            if (left > right)
            {
